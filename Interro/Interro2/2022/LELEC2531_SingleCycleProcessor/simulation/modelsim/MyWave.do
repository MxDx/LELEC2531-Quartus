...
add wave -noupdate -label PC -radix hexadecimal -radixshowbase 0 /MyTestbench/PC
add wave -noupdate -label Instr -radix hexadecimal -radixshowbase 0 /MyTestbench/dut/arm/c/Instr
add wave -noupdate -label ALUResult -radix hexadecimal -radixshowbase 0 /MyTestbench/dut/arm/dp/ALUResult
add wave -noupdate -label WriteData -radix hexadecimal /MyTestbench/WriteData
add wave -noupdate -label MemWrite -radix hexadecimal -radixshowbase 0 /MyTestbench/MemWrite
add wave -noupdate -label ReadData -radix hexadecimal -radixshowbase 0 /MyTestbench/dut/arm/dp/ReadData
